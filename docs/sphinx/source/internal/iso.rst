...
..  figure::images/disc_organization.png
    ...
    Disc organization of a Wii ISO
...
..  figure:: images/partition_header.png
    :align: center
...
..  figure:: images/sequence_title_key_decrypt.png
    :align: center
...
..  figure:: images/data_encryption.png
    :align: center
...
Before, in the header we said that it contains H0, H1, etc. It's from a `Merkle Tree`_, a tree with every node that is not a leaf is a hash of its child.
For Wii ISO, it's like this:

..  figure:: images/merkle_tree.png
    :align: center
...
..  figure:: images/sequence_encryption.png
    :align: center
...
* `WiiBrew - Wii Disc Header`_
* `WiiBrew - Decrypted Header`_
* `WiiBrew - Wii Disc`_
* `WiiBrew - Ticket`_
* `WiiBrew - Title Metadata`_
* `WiiBrew - Certificate Chain`_
* `WiiBrew - DOL`_
* `WiiBrew - Partitions Information`_
* `WiiBrew - Partition`_
* `WiiBrew - Wii Disc - Encrytped`_

.. _Ticket: https://wiibrew.org/wiki/Ticket
.. _TMD: https://wiibrew.org/wiki/Title_metadata

.. _WiiBrew - Wii Disc Header: https://wiibrew.org/wiki/Wii_disc#Header
.. _WiiBrew - Decrypted Header: https://wiibrew.org/wiki/Wii_disc#Decrypted=


.. _WiiBrew - Wii Disc: https://wiibrew.org/wiki/Wii_disc
.. _WiiBrew - Ticket: https://wiibrew.org/wiki/Ticket
.. _WiiBrew - Title Metadata: https://wiibrew.org/wiki/Title_metadata
.. _WiiBrew - Certificate Chain: https://wiibrew.org/wiki/Certificate_chain
.. _WiiBrew - DOL: https://wiibrew.org/wiki/DOL
.. _WiiBrew - Partitions Information: https://wiibrew.org/wiki/Wii_disc#Partitions_information
.. _WiiBrew - Partition: https://wiibrew.org/wiki/Wii_disc#Partition
.. _WiiBrew - Wii Disc - Encrytped: https://wiibrew.org/wiki/Wii_disc#Encrypted
