...
..  figure:: images/yaz0/structure.png
    :align: center
...
Flowchart
^^^^^^^^^
..  figure:: images/yaz0/decompression.png
    :align: center

    Decompression flowchart of a Yaz0
...
Flowchart
^^^^^^^^^
..  figure:: images/yaz0/compression.png
    :align: center

    Compression flowchart of a Yaz0
...
.. _Custom Mario Kart Wiiki: https://wiki.tockdom.com/wiki/YAZ0_(File_Format)
.. _Amnoid.de: http://www.amnoid.de/gc/yaz0.txt